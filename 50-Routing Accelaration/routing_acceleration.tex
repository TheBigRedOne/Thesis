...
\label{sec:routing_acceleration:motivation_beyond_forwarding-plane_recovery}
...
\label{sec:routing_acceleration:design_overview}
...
\label{sec:routing_acc:success-driven_locality_information}
...
\label{sec:routing_acceleration:fast-lsa_mechanism}
...
\label{sec:routingacc:interaction_with_optoFlood}
...
\label{sec:routing_acceleration:trade-offs_and_safety_considerations}
...
\label{sec:routing_acceleration:evaluation_plan}
...
\section{Summary}
\label{sec:routing_acceleration:summary}
